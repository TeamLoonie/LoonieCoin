...
* Ask for help on [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or on the [PIVX Forum](http://forum.loonie.io/).
* Join one of our Slack groups [PIVX Slack Groups](https://loonie.io/slack-logins/).
...
Development
---------------------
The LOONIE repo's [root README](https://github.com/PIVX-Project/PIVX/blob/master/README.md) contains relevant information on the development process and automated testing.
...
* Discuss on the [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or the [PIVX](http://forum.loonie.io/) forum.
* Join the [PIVX-Dev](https://loonie-dev.slack.com/) Slack group ([Sign-Up](https://loonie-dev.herokuapp.com/)).
