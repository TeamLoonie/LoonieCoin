...
git clone https://github.com/loonie-crypto/loonie.git
cd loonie
...
```bash
    ...
    From https://github.com/loonie-crypto/loonie
...
For example:
```bash
URL=https://github.com/crowning-/loonie.git
