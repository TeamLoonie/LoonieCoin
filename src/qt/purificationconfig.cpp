...
void PurificationConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("Purification Configuration"),
        tr(
            "Purification was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening LOONIE's configuration screen.")
            .arg(strAmount));
...
void PurificationConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("Purification Configuration"),
        tr(
            "Purification was successfully set to high (%1 and 8 rounds). You can change this at any time by opening LOONIE's configuration screen.")
            .arg(strAmount));
...
void PurificationConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("Purification Configuration"),
        tr(
            "Purification was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening LOONIE's configuration screen.")
            .arg(strAmount));
