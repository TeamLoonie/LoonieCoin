...
Value purification(const Array& params, bool fHelp)
{
    if (fHelp || params.size() == 0)
        throw runtime_error(
            "purification <loonieaddress> <amount>\n"
    ...
    if (params[0].get_str() == "reset") {
        ...
        return "successfully reset purification";
    }
...
Value masternodeconnect(const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 1))
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("masternodeconnect", "\"192.168.0.6:3734\"") + HelpExampleRpc("masternodeconnect", "\"192.168.0.6:3734\""));
...
Value getmasternodecount (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() > 0))
        throw runtime_error(
            ...
            "  \"obfcompat\": n,    (numeric) Purification Compatible\n"
