...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"purification_balance\": xxxxxx, (numeric) the anonymized loonie balance of the wallet\n"
    ...
    if (pwalletMain) {
        ...
        if (!fLiteMode)
            obj.push_back(Pair("purification_balance", ValueFromAmount(pwalletMain->GetAnonymizedBalance())));
    }
#endif
